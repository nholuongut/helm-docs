...
import (
	...
	"github.com/nholuongut/helm-docs/pkg/util"

	log "github.com/sirupsen/logrus"

	"github.com/nholuongut/helm-docs/pkg/helm"
)
...
func getHelmDocsVersionTemplates() string {
	...
	versionSectionBuilder.WriteString("Autogenerated from chart metadata using [helm-docs v{{ .HelmDocsVersion }}](https://github.com/nholuongut/helm-docs/releases/v{{ .HelmDocsVersion }})")
