...
config:
  databasesToCreate:
    ...
    # -- database for the [hashbash](https://github.com/nholuongut/hashbash-backend-go) project
    - hashbash
...
| config.databasesToCreate[1] | string | `"hashbash"` | database for the [hashbash](https://github.com/nholuongut/hashbash-backend-go) project |
...
```bash
brew install nholuongut/tap/helm-docs
```
...
This will download and install the [latest release](https://github.com/nholuongut/helm-docs/releases/latest)
of the tool.
...
```bash
go install github.com/nholuongut/helm-docs/cmd/helm-docs@latest
```
...
---
repos:
  - repo: https://github.com/nholuongut/helm-docs
    rev:  ""
    hooks:
      - id: helm-docs
        args:
...
The tool also includes the [sprig templating library](https://github.com/nholuongut/sprig), so those functions can be used
